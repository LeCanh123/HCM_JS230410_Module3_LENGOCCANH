...
const AdminManageProduct = () => {
  ...
  const handleSubmit =async (e) => {
    e.preventDefault();
    console.log("handleSubmit",product.categoryId);
    let categoryId1="";
    if(product.categoryId=="Kurtas and Kurtis"){categoryId1=3}
    if(product.categoryId=="Dresses and Jumpsuits"){categoryId1=4}
    if(product.categoryId=="Casual Shirts"){categoryId1=5}
    if(product.categoryId=="Jeans"){categoryId1=7}

    let addproduct=await apis.addnewproduct({
      title:product.title,
      image:product.image,
      img1:product.img1,
      img2:product.img2,
    ...
    setProduct({...initailState,categoryId:categoryId1,});
  };
...
// });
// <select id="mySelect">
//   <!-- Các tùy chọn sẽ được tạo động bằng JavaScript -->
// </select>